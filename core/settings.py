...
SECRET_KEY = 'django-insecure-cyw&#+wq0l87*!!g_!_gu5-dpf#fs@ivj*hk2hy4(&((^2cam('
...
# STATIC_URL = '/static/'
# STATICFILES_DIR = [os.path.join(BASE_DIR, 'static')] ## create a folder caled /static (for production side)
# STATIC_ROOT = os.path.join(BASE_DIR, 'static_root')

# MEDIA_URL = '/media/'
# MEDIA_ROOT = os.path.join(BASE_DIR, 'media') #create a folder caled /static (that setting for the production side)
